            ...
            <div class="panel panel-default wk-panel ">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-inline"> 
                      ...
                      <div class="form-inline">  
                            <div class="form-group">
                                <label for="filePath" class="control-label wk-filed-label">讨论话题: </label>
                                 <div class="input-group">
                                    <input required="required" name="title" type="text" class="form-control wk-long-2col-input" id="mark" placeholder="请输入讨论话题"/>
                                </div>
                            </div>
                        </div>

...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default wk-panel ">
				<div class="panel-heading">作业练习</div>
				<form id="taskForm"
					action="<%=basePath%>saveStudentTask/${taskId}.html" method="POST">
					<div class="panel-body">
						<div class="row">
							<c:forEach items="${questions}" var="var">
								<div class="form-inline">
									<div class="form-group">
										<label class="control-label wk-filed-label">题目:
											${var.title} </label>
									</div>
								</div>
								<div class="form-inline">
					...
					<div class="panel-footer wk-panel-footer">
						<button id="submitBtn" type="button"
							class="btn btn-default wk-btn">提&nbsp;&nbsp;交</button>
					</div>
				</form>
			</div>
		</div>
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="taskConfirm">

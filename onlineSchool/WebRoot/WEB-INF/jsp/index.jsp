	...
	<div class="row">
		<div class="col-lg-12">
			<ul class="nav nav-tabs wk-nav-menu" id="wk-nav-menu">
				<li role="presentation"><a id="leftNav">管理员端</a></li>
				<li role="presentation"><a href="javascript:void();"
					id="wk-menu-panel-item-createStudent" class="wk-main-menu-item">新增学生</a></li>
				<li role="presentation"><a href="javascript:void();"
					id="wk-menu-panel-item-searchStudent" class="wk-main-menu-item">学生信息查询</a></li>
				<li role="presentation"><a href="javascript:void();"
					id="wk-menu-panel-item-createTeacher" class="wk-main-menu-item">新增教师</a></li>
				<li role="presentation"><a href="javascript:void();"
					id="wk-menu-panel-item-searchTeacher" class="wk-main-menu-item">教师信息查询</a></li>
				<li role="presentation"><a href="javascript:void();"
					id="wk-menu-panel-item-createCollege" class="wk-main-menu-item">新增学院</a></li>
				<li role="presentation"><a href="javascript:void();"
					id="wk-menu-panel-item-searchCollege" class="wk-main-menu-item">学院信息管理</a></li>
				<li role="presentation"><a href="javascript:void();"
					id="wk-menu-panel-item-createCourse" class="wk-main-menu-item">新增课程</a></li>
				<li role="presentation"><a href="javascript:void();"
					id="wk-menu-panel-item-searchCourse" class="wk-main-menu-item">课程信息查询</a></li>
					...
					<div class="panel-group wk-accordion-panel-group" id="accordion">
						<div class="panel panel-info wk-accordion-header">
							<div class="panel-heading">
								<a data-toggle="collapse" href="#AMenu" data-parent="#accordion">学生管理</a>
							</div>
							...
							<div id="AMenu" class="panel-collapse collapse">
								<div class="list-group wk-accordion-list-group">
									...
									<button type="button" class="list-group-item"
										...
										>&nbsp;&nbsp;学生信息</button>
									<button type="button" class="list-group-item"
										id="wk-menu-panel-item-searchStudentRecharge">
										>&nbsp;&nbsp;学生充值记录</button>
						...
						<div class="panel panel-info wk-accordion-header">
							<div class="panel-heading">
								<a data-toggle="collapse" href="#BMenu" data-parent="#accordion">教师管理</a>
							</div>
						...
						<div class="panel panel-info wk-accordion-header">
							...
							<div id="DMenu" class="panel-collapse collapse">
								<div class="list-group wk-accordion-list-group">
									<button type="button" class="list-group-item"
										id="wk-menu-panel-item-searchTeacherCourseVideo">
										>&nbsp;&nbsp;课程视频</button>
									<button type="button" class="list-group-item"
										id="wk-menu-panel-item-searchTeacherCourseFile">
										>&nbsp;&nbsp;课程资料</button>
									<button type="button" class="list-group-item"
										id="wk-menu-panel-item-searchCourse">
										>&nbsp;&nbsp;课程信息</button>
								</div>
							</div>
						</div>
						...
						<div class="panel panel-info wk-accordion-header">
							...
							<div id="FMenu" class="panel-collapse collapse">
								<div class="list-group wk-accordion-list-group">
									<button type="button" class="list-group-item"
										id="wk-menu-panel-item-createNotice">
										>&nbsp;&nbsp;新增公告</button>
									<button type="button" class="list-group-item"
										id="wk-menu-panel-item-searchNotice">
										>&nbsp;&nbsp;公告信息查询</button>
								</div>
							</div>
						</div>

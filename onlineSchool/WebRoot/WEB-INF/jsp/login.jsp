...
<meta name="description" content="xingLinOnlineSchool" />
<meta name="keywords" content="杏林网校，知识共享!共祝教育事业！  " />
<meta name="author" content="xor" />
...
<body>
	<div class="limiter" id="loginContainer">
		<div class="container-login100"
			style="background-image: url('resource/images/bg-02.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<!-- 登录form -->
				<form class="login100-form validate-form"	action="<%=basePath%>userlogin.html" method="POST"  style="height:480px;">
					<span class="login100-form-title p-b-49 loginTitle">杏林网校</span>
					...
					<div style="margin-top:10px; float:left;">
						<span class="label-input100 label">用户类型&nbsp;&nbsp;&nbsp;&nbsp;</span>
						<div class="role">
					...
					<div class="copyright">
						<a> ©2019-11-28 Designed by 工具人 </a>
					</div>
				</form>
			</div>
		</div>

	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default wk-panel ">
				...
				<form action="<%=basePath%>editStudentInfo/${student.id}.html"
					method="POST">
						...
						<div class="row">
							<div class="form-inline">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input required="required" name="num" type="text" readonly unselectable="on"
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input required="required" name="telphone" type="tel"
											...
											value="${student.telphone}" placeholder="请输入联系电话" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="input-group">
										<input required="required" name="idCardNo" type="text"
											class="form-control wk-normal-input"
											value="${student.idCardNo}" placeholder="请输入身份证号" />
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input required="required" name="account" type="text"
											class="form-control wk-normal-input"
											value="${student.account}" placeholder="请输入登录账户" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="input-group">
										<input required="required" name="password" type="password"
											class="form-control wk-normal-input"
											value="${student.password}" placeholder="请输入登录密码" />
									</div>
								</div>
								<div class="form-group">
									<label class="control-label wk-filed-label">杏林币: </label>
									<div class="input-group">
										<input required="required" name="coin" type="text"
											readonly unselectable="on" class="form-control wk-normal-input"
											value="${student.coin}" placeholder="请输入杏林币数目" />
									</div>
								</div>
							</div>
						</div>

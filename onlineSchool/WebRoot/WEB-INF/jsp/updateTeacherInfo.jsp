	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default wk-panel ">
				...
				<form action="<%=basePath%>editTeacherInfo/${teacher.id}.html"
					method="POST">
						...
						<div class="row">
							<div class="form-inline">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input required="required" name="num" type="text" readonly
											unselectable="on" class="form-control wk-normal-input"
											value="${teacher.num}" placeholder="请输入教师编号" />
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input required="required" name="telphone" type="tel"
											...
											value="${teacher.telphone}" placeholder="请输入联系电话" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="input-group">
										<input required="required" name="idCardNo" type="text"
											class="form-control wk-normal-input"
											value="${teacher.idCardNo}" placeholder="请输入身份证号" />
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<input required="required" name="account" type="text"
											class="form-control wk-normal-input"
											value="${teacher.account}" placeholder="请输入登录账户" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="input-group">
										<input required="required" name="password" type="password"
											class="form-control wk-normal-input"
											value="${teacher.password}" placeholder="请输入登录密码" />
									</div>
								</div>
							</div>

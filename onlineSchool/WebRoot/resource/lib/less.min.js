	...
	return function a(b, c, d) {
			...
			b.exports = function(a, b, c) {
				function f(b, f) {
					var g,
						...
						m = b.filename || f,
						n = m.match(/([^\/]+(\?.*)?)$/)[1];
					k.id = i, k.className = "less-error-message", h = "<h3>" + (b.type || "Syntax") + "Error: " + (b.message || "There is an error in your .less file") + '</h3><p>in <a href="' + m + '">' + n + "</a> ";var o = function(a, b, c) {
			...
			b.exports = function(b) {
				...
				h.add("svg-gradient", function(a) {
					...
					case "to bottom":
						...
						break;case "to bottom right":
						i = 'x1="0%" y1="0%" x2="100%" y2="100%"';
						break;case "to top right":
			...
			b.exports = function(a) {
				...
				return b.prototype.toCSS = function(b) {
						...
						try {
							...
							j && f.warn("The compress option has been deprecated. We recommend you use a dedicated css minifier, for instance see less-plugin-clean-css.");var k = {
								compress : j,
				...
				for (h = 0; h < m; h++)
					if (j = a.charCodeAt(h), !(j >= 97 && j <= 122 || j < 34)) switch (j) {
						case 40:
							...
							n || o || c();continue;case 92:
							if (h < m - 1) {
								h++;continue
							}
							return b("unescaped `\\`", h);case 34:
						case 39:
						case 96:
							...
							if (l) continue;
							return b("unmatched `" + String.fromCharCode(j) + "`", i);case 47:
							if (o || h == m - 1) continue;
					...
					for (var e, f, j, p = k.i, q = c, s = k.i - i, t = k.i + h.length - s, u = k.i += d, v = b; k.i < t; k.i++) {
						if (e = v.charCodeAt(k.i), k.autoCommentAbsorb && e === r) {
							if (f = v.charAt(k.i + 1), "/" === f) {
								...
								var w = v.indexOf("\n", k.i + 2);
								w < 0 && (w = t), k.i = w, j.text = v.substr(j.index, k.i - j.index), k.commentStore.push(j);continue
							}
							if ("*" === f) {
								...
								if (x >= 0) {
									j = {
										...
										isLineComment : !1
									}, k.i += j.text.length - 1, k.commentStore.push(j);continue
								}
							}
							break
						}
						...
						parsers : n = {
							primary : function() {
								for (var a, b = this.mixin, c = [];;) {
									...
									if (a = this.extendRule())
										c = c.concat(a);
									else if (a = b.definition() || this.rule() || this.ruleset() || b.call() || this.rulesetCall() || this.entities.call() || this.directive()) c.push(a);else {
							...
							mixin : {
								...
								args : function(a) {
									...
									for (o.save();;) {
										if (a)
											h = n.detachedRuleset() || n.expression();else {
										...
										if (!h) break;
										f = null, h.throwAwayComments && h.throwAwayComments(), g = h;var r = null;
			...
			var d = a("./node"),
				...
				j = function(a, b, c, d, e, f) {
					if (this.options = c, this.index = d, this.path = a, this.features = b, this.currentFileInfo = e, this.allowRoot = !0, void 0 !== this.options.less || this.options.inline)
						this.css = !this.options.less || this.options.inline;else {
						var g = this.getPath();
		...
		66 : [ function(a, b, c) {
			...
			j.prototype = new i, j.prototype.type = "Media", j.prototype.isRulesetLike = !0, j.prototype.accept = function(a) {
				...
				var c = !1;
				a.strictMath || (c = !0, a.strictMath = !0);try {
		...
		74 : [ function(a, b, c) {
			...
			h.prototype = new e, h.prototype.type = "Rule", h.prototype.genCSS = function(a, b) {
				...
				var b,
					...
					e = this.name,
					f = this.variable;
				"string" != typeof e && (e = 1 === e.length && e[0] instanceof g ? e[0].value : d(a, e), f = !1), "font" !== e || a.strictMath || (c = !0, a.strictMath = !0);try {
		...
		76 : [ function(a, b, c) {
			...
			m.prototype = new d, m.prototype.type = "Ruleset", m.prototype.isRuleset = !0, m.prototype.isRulesetLike = !0, m.prototype.accept = function(a) {
				...
				for (d = 0; d < j.length; d++) {
					g = j[d], d + 1 === j.length && (a.lastRule = !0);var t = a.lastRule;
					...
					for (o = [], p = [ [] ], h = 0; h < c.elements.length; h++)
						if (s = c.elements[h], "&" !== s.value) {
							...
							for (v = !0, q = [], k(o, p), m = 0; m < p.length; m++)
								if (r = p[m], 0 === b.length) r.length > 0 && r[0].elements.push(new g(s.combinator, "", s.index, s.currentFileInfo)), q.push(r);else
